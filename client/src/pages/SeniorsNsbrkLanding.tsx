...
export default function SeniorsLanding() {
  ...
  useEffect(() => {
    ...
    initGTM();
    trackPageView('/final-expense/nsbrk/', 'Seniors Final Expense - NewsBreak');
  ...
  useEffect(() => {
    if (step <= 8) {
      const stepNames = ['Beneficiary', 'Life Insurance', 'Age', 'Beneficiary Name', 'Coverage Amount', 'Monthly Budget', 'Beneficiary Name', 'Contact Info'];
  ...
  const getProgressPercentage = (currentStep: number): number => {
    const progressMap: Record<number, number> = {
      ...
      2: 22,  // Life Insurance
      3: 33,  // Age
      4: 44,  // Beneficiary Name
      5: 56,  // Coverage Amount
      6: 67,  // Monthly Budget
      7: 78,  // Beneficiary Name (second)
      8: 89,  // Contact Info
      9: 100  // Thank You
    };
